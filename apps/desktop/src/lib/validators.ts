...
export const validateSettings = (input: unknown) => settingsSchema.safeParse(input);

export const validateSetup = (input: unknown) => setupSchema.safeParse(input);

export const validateVoicePreset = (input: unknown) => voicePresetSchema.safeParse(input);
